#' Solve for one gene as formulated in DeltaNeTS (Y=XB) with Lasso and cross validation. 
#' @param X - design matrix with time slope matrix already incorporated
...
function(X,y,n_df,options,kfold){
